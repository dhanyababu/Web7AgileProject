...
Verify first hotel
        ${hotel_name}=                  Get Text                        xpath:/html/body/div/main/div[2]/div[1]/div/div[1]/div[2]/div[1]
        Should Be Equal                 ${hotel_name}                   Ritz Hotel Paris
        Locator Should Match X Times    xpath:/html/body/div/main/div[2]/div[1]/div/div[1]/div[2]/div[2]/*    5
        ${place_link}=                  Get Text                        xpath:/html/body/div/main/div[2]/div[1]/div/div[1]/div[2]/div[3]/p[1]
        Should Be Equal                 ${place_link}                   15 Place Vendôme, 75001, Paris, France
        ${distance_link}=               Get Text                        xpath:/html/body/div/main/div[2]/div[1]/div/div[1]/div[2]/div[3]/p[2]
...
Verify second hotel
        ${hotel_name}=                 Get Text                         xpath:/html/body/div/main/div[2]/div[2]/div/div[1]/div[2]/div[1]
        Should Be Equal                 ${hotel_name}                   Corinthia Hotel London
        Locator Should Match X Times    xpath:/html/body/div/main/div[2]/div[2]/div/div[1]/div[2]/div[2]/*    5
        ${place_link}=                  Get Text                        xpath:/html/body/div/main/div[2]/div[2]/div/div[1]/div[2]/div[3]/p[1]
        Should Be Equal                 ${place_link}                   Whitehall Place, SW1A 2BD, London, United Kingdom
        ${distance_link}=               Get Text                        xpath:/html/body/div/main/div[2]/div[2]/div/div[1]/div[2]/div[3]/p[2]
...
Verify third hotel
        ${hotel_name}=                  Get Text                        xpath:/html/body/div/main/div[2]/div[3]/div/div[1]/div[2]/div[1]
        Should Be Equal                 ${hotel_name}                   Eden Hotel Amsterdam
        Locator Should Match X Times    xpath:/html/body/div/main/div[2]/div[3]/div/div[1]/div[2]/div[2]/*    4
        ${place_link}=                  Get Text                        xpath:/html/body/div/main/div[2]/div[3]/div/div[1]/div[2]/div[3]/p[1]
        Should Be Equal                 ${place_link}                   Amstelstraat 17, 1017 DA, Amsterdam, Netherlands
        ${distance_link}=               Get Text                        xpath:/html/body/div/main/div[2]/div[3]/div/div[1]/div[2]/div[3]/p[2]
