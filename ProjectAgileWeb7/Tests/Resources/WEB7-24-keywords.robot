...
Verify first hotel
        ...
        ${extern_link}=                 Get Text                        xpath:/html/body/div[1]/main/div[2]/div[2]/div[1]/div/div[1]/div[2]/div[7]/p
        Should Be Equal                 ${extern_link}                  https://www.ritzparis.com/en-GB
        Click Element                   xpath:/html/body/div[1]/main/div[2]/div[2]/div[1]/div/div[1]/div[2]/div[7]/p/a
...
Verify second hotel
        ...
        Element Should Contain          xpath:/html/body/div[1]/main/div[2]/div[2]/div[2]/div/div[1]/div[2]/div[5]        Available rooms
        Element Should Contain          xpath:/html/body/div[1]/main/div[2]/div[2]/div[2]/div/div[1]/div[2]/div[6]        Facilities:
        Element Should Be Visible       xpath:/html/body/div[1]/main/div[2]/div[2]/div[2]/div/div[2]/a
        ${extern_link}=                 Get Text                        xpath:/html/body/div[1]/main/div[2]/div[2]/div[2]/div/div[1]/div[2]/div[7]/p
        Should Be Equal                 ${extern_link}                  https://www.corinthia.com/london/
        Click Element                   xpath:/html/body/div[1]/main/div[2]/div[2]/div[2]/div/div[1]/div[2]/div[7]/p/a
...
Verify third hotel
        ...
        Should Be Equal                 ${discription_link}             Located in the heart of the city center, Eden Hotel Amsterdam offers warm-colored rooms and free WiFi. The famous Rembrandt Square is right around the corner. The central station is 10 minutes away by tram.
        Element Should Contain          xpath:/html/body/div[1]/main/div[2]/div[2]/div[3]/div/div[1]/div[2]/div[5]       Available rooms
        Element Should Contain          xpath:/html/body/div[1]/main/div[2]/div[2]/div[3]/div/div[1]/div[2]/div[6]       Facilities
        Element Should Be Visible       xpath:/html/body/div[1]/main/div[2]/div[2]/div[3]/div/div[2]/a
        ${extern_link}=                 Get Text                        xpath:/html/body/div[1]/main/div[2]/div[2]/div[3]/div/div[1]/div[2]/div[7]/p
        Should Be Equal                 ${extern_link}                  https://www.edenhotelamsterdam.com/en/
        Click Element                   xpath:/html/body/div[1]/main/div[2]/div[2]/div[3]/div/div[1]/div[2]/div[7]/p/a
